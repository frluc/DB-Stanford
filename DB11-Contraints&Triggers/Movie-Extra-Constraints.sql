...
create table Movie(
	...
	unique (title, year),
	check (
		(director = "Steven Spielberg" and year < 1990)
		or (director = "James Cameron" and year > 1990)
		or (director <> "Steven Spielberg" and director <> "James Cameron")
		)
	);
...
create table Rating(
	...
	stars int not null check (stars in (1,2,3,4,5)),
	ratingDate date check (ratingDate > 2000-31-12),
